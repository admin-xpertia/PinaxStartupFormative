...
async function verifySchema() {
  ...
  try {
    ...
    // Autenticar con namespace y database
    await db.signin({
      NS: 'StartupFormative',
      DB: 'Roadmap',
      user: 'admin',
    ...
    console.log(JSON.stringify(infoComponente, null, 2));
    console.log('\n');
    ...
    console.log(JSON.stringify(infoValidacion, null, 2));
    console.log('\n');
    ...
    console.log('📊 Total de registros en componente_contenido:', JSON.stringify(countComponente));
    ...
    console.log('📊 Total de registros en validacion_calidad:', JSON.stringify(countValidacion));
