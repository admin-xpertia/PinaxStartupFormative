...
async function recreateTables() {
  ...
  try {
    ...
    console.log("Cargando script de recreación de tablas...");
    const scriptPath = path.join(__dirname, 'recreate-tables.surql');
    const script = await fs.readFile(scriptPath, 'utf8');

    console.log("Ejecutando recreación de tablas...");
