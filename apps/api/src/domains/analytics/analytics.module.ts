...
import { AnalyticsController, StudentDetailController } from './analytics.controller';
...
@Module({
  ...
  controllers: [AnalyticsController, StudentDetailController, DashboardStatsController],
