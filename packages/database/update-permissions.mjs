...
async function updatePermissions() {
  ...
  try {
    ...
    console.log("Cargando script de actualización de permisos...");
    const scriptPath = path.join(__dirname, 'update-permissions.surql');
    const script = await fs.readFile(scriptPath, 'utf8');

    console.log("Ejecutando actualización de permisos...");
